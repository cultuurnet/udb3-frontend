...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        'tw:data-[selected-single=true]:bg-success tw:data-[selected-single=true]:text-success-foreground tw:data-[range-middle=true]:bg-accent tw:data-[range-middle=true]:text-accent-foreground tw:data-[range-start=true]:bg-success tw:data-[range-start=true]:text-success-foreground tw:data-[range-end=true]:bg-success tw:data-[range-end=true]:text-success-foreground tw:data-[outside=true]:text-muted-foreground tw:data-[today=true]:bg-muted tw:data-[today=true]:text-foreground tw:data-[today=true]:font-bold tw:hover:bg-muted tw:group-data-[focused=true]/day:border-ring tw:group-data-[focused=true]/day:ring-ring/50 tw:flex tw:aspect-square tw:h-auto tw:w-full tw:min-w-(--cell-size) tw:flex-col tw:gap-1 tw:font-normal tw:leading-none tw:data-[range-end=true]:rounded-md tw:data-[range-middle=true]:rounded-none tw:data-[range-start=true]:rounded-md tw:group-data-[focused=true]/day:relative tw:group-data-[focused=true]/day:z-10 tw:group-data-[focused=true]/day:ring-[3px] tw:[&>span]:text-xs tw:[&>span]:opacity-70',
        defaultClassNames.day,
        className,
      )}
      {...props}
