...
describe('CultururKuurLabelsManager', () => {
  test('can toggle a label', () => {
    ...
    expect(manager.isLabelSelected('cultuurkuur_werkingsregio_nis-21001')).toBe(false);
    manager.handleSelectionToggle(
      dummyMunicipalities[0].children[0].children[0],
    );
    expect(manager.isLabelSelected('cultuurkuur_werkingsregio_nis-21001')).toBe(true);
  });
  ...
  test('can test if group is fully selected', () => {
    ...
    expect(manager.isLabelSelected('cultuurkuur_werkingsregio_provincie_nis-01000')).toBe(true);
    ...
    expect(manager.isLabelSelected('cultuurkuur_werkingsregio_provincie_nis-01000')).toBe(false);
  });
  ...
  test('can infer a full state from leaf states', () => {
    ...
    console.log(dummyMunicipalities[3].children[0]);
    expect(
