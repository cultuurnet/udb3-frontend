...
const Svg = ({ className, ...props }) => {
    return (<Box className={className} forwardedAs="svg" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="10 30 20 20" css="overflow: visible;" width={20} height={20} {...props}/>);
};
Svg.propTypes = {
    className: PropTypes.string,
};
const BusyIcon = ({ className }) => (<Svg className={className}>
    <g fillRule="evenodd" fill="none">
      ...
      <g css={`
        ...
        `} strokeWidth="2" transform="translate(14 34)" className="busy-spinner">
        <path d="M12 6c0-6-6-6-6-6" transform="rotate(308.674 6 6)">
          <animateTransform repeatCount="indefinite" dur="1s" to="360 6 6" from="0 6 6" type="rotate" attributeName="transform"/>
        </path>
      </g>
    </g>
  </Svg>);
...
`;
const CompleteIcon = ({ className }) => (<Svg animation={css `
    ...
    <g fillRule="evenodd" fill="none">
      ...
      <g css={`
        ...
        `} strokeWidth="2" transform="translate(-6 14)">
...
`;
const WarningIcon = ({ className }) => (<Svg className={className} animation={css `
...
JobLoggerStateIndicator.propTypes = {
    state: (PropTypes as any).oneOf(Object.values(JobLoggerStates)),
};
