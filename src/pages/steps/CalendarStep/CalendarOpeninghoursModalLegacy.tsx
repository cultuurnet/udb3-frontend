...
type CalendarOpeninghoursModalLegacyProps = {
  visible: boolean;
  onClose: () => void;
  onChangeCalendarState: (newSate: CalendarState) => void;
};

const CalendarOpeninghoursModalLegacy = ({
  visible,
  onClose,
  onChangeCalendarState,
}: CalendarOpeninghoursModalLegacyProps) => {
...
export { CalendarOpeninghoursModalLegacy };
