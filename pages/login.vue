    ...
    <div class="hero">
      <div class="container">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 250">
          ...
          <path
            class="line line--left line--theater"
            stroke-width="3"
          ...
          ></path>
          <path
            class="line line--left line--guitar"
            stroke-width="3"
            stroke-miterlimit="10"
            fill="none"
            d="M217 147.5h121"
          ></path>
          <path
            class="line line--left line--tennis"
            stroke-width="3"
            stroke-miterlimit="10"
            fill="none"
          ...
          ></path>
          <path
            class="line line--left line--movie"
            stroke-width="3"
            stroke-miterlimit="10"
            fill="none"
            d="M102 138.5h235"
          ></path>
          <path
            class="line line--right line--public--front"
            stroke-width="3"
            stroke-miterlimit="10"
            fill="none"
          ...
          ></path>
          <path
            class="line line--right line--public--mid"
            stroke-width="3"
            stroke-miterlimit="10"
            fill="none"
            d="M579 140.5h89"
          ></path>
          <path
            class="line line--right line--public--back"
            stroke-width="3"
            stroke-miterlimit="10"
            fill="none"
